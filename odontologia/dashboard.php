...
for ($i = 0; $i <= 6; $i++) {
    ...
    $resultado = $conn->query("SELECT COUNT(*) AS total FROM Turnos WHERE fecha_turno = '$fecha'");
    $cantidad = $resultado->fetch_assoc()['total'];
    $fechas[] = date("d/m", strtotime($fecha));
    $turnosPorDia[] = $cantidad;
}
?>
...
<div class="container mt-5">
  ...
  <div class="mt-5">
    <h4 class="text-center text-secondary mb-4">📈 Turnos en los próximos 7 días</h4>
