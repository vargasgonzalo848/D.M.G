...
<head>
  ...
  <style>
    ...
    .hero {
      background: url('https://images.unsplash.com/photo-1588776814546-7e9a52c9d00f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8ZGVudGlzdHxlbnwwfHwwfHw%3D&ixlib=rb-4.0.3&q=80&w=1080') no-repeat center center;
...
<body>
  ...
  <section class="hero text-center">
    <div>
      <h1 class="display-4">Bienvenido a Odontología Sonrisa</h1>
