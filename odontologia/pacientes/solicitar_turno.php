...
<div class="container mt-5" style="max-width: 600px;">
    ...
    <form method="POST" action="">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="motivo" name="motivo" rows="3" required><?= htmlspecialchars($servicio_prefill) ?></textarea>
            <small class="text-muted">El motivo se completó automáticamente según el servicio seleccionado. Puedes agregar detalles adicionales si quieres.</small>
        </div>
