...
<div class="container my-5">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-6">
            ...
            <ul class="list-group">
                <li class="list-group-item"><strong>Lunes a Viernes:</strong> 08:00 AM - 08:00 PM</li>
                <li class="list-group-item"><strong>Sábado:</strong> 09:00 AM - 02:00 PM</li>
                <li class="list-group-item"><strong>Domingo:</strong> Cerrado</li>
            </ul>

            <h4 class="mt-4">Agenda tu cita</h4>
            <p>Para reservar tu turno, puedes llamarnos al número de teléfono o enviarnos un correo electrónico.</p>
            <a href="pacientes/solicitar_turno.php" class="btn btn-primary mt-2">Reservar Turno</a>
        </div>
    </div>
